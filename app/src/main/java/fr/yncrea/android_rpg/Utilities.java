...
public class Utilities {
    ...
    public static List<String> populateFirstList(List<Choice> situation, int index){
    ...
    public static List<String> populateSecondList(List<Choice> situation, int index){
